    ...
    def get(self, request):
        ...
        try:
            ...
            agent_status = {
                ...
                'successful_conversions': ai_agent.successful_conversions,
                'conversion_rate': ai_agent.conversion_rate,
                'customer_satisfaction': ai_agent.customer_satisfaction,
                'is_ready': ai_agent.status in ['active', 'learning']
            }
